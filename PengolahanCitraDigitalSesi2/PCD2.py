...
paths = [
    r"E:\CODINGAN\PengolahanCitraDigitalSesi2\DaunPepaya.jpg",
    r"E:\CODINGAN\PengolahanCitraDigitalSesi2\DaunSingkong.jpg",
    r"E:\CODINGAN\PengolahanCitraDigitalSesi2\DaunKenikir.jpg"
]
...
def process_image(path):
    ...
    imageio.imwrite(f"{file_name}_red.jpg", image_red)
    imageio.imwrite(f"{file_name}_green.jpg", image_green)
    imageio.imwrite(f"{file_name}_blue.jpg", image_blue)
    imageio.imwrite(f"{file_name}_grayscale.jpg", image_grayscale)
    imageio.imwrite(f"{file_name}_threshold.jpg", image_threshold)
